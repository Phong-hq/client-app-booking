...
export const useNewAppointmentStore = defineStore({
  id: 'new-appointment',
  state: () => ({
    header: { 
    ...
    caterogyList:[
      {id: 0, name: 'Manicures ', serviceList: [
          {id: 0, name: 'Gel Manicure ', duration: '30', price: 24, selected: false, },
          {id: 1, name: 'Gel Manicure ', duration: '30', price: 24, selected: false, },
          {id: 2, name: 'Gel Manicure ', duration: '30', price: 24, selected: false, },
          {id: 3, name: 'Gel Manicure ', duration: '30', price: 24, selected: false, },
          {id: 4, name: 'Gel Manicure ', duration: '30', price: 24, selected: false, },
      ]},
      {id: 1, name: 'Manicures ', serviceList: [
          {id: 0, name: 'Gel Manicure ', duration: '30', price: 24, selected: false, },
          {id: 1, name: 'Gel Manicure ', duration: '30', price: 24, selected: false, },
          {id: 2, name: 'Gel Manicure ', duration: '30', price: 24, selected: false, },
          {id: 3, name: 'Gel Manicure ', duration: '30', price: 24, selected: false, },
      ...
      {id: 2, name: 'Manicures ', serviceList: [
          {id: 0, name: 'Gel Manicure ', duration: '30', price: 24, selected: false, },
          {id: 1, name: 'Gel Manicure ', duration: '30', price: 24, selected: false, },
          {id: 2, name: 'Gel Manicure ', duration: '30', price: 24, selected: false, },
          {id: 3, name: 'Gel Manicure ', duration: '30', price: 24, selected: false, },
  ...
  getters: {
    getCaterogyList: (state) => state.caterogyList,
  },
  actions: {
    setWeekList(day){
